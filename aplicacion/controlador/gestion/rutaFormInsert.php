...
echo '<div class="tablaFormInsertCabec"> Ingresar Ruta   <img style="position:absolute;left:95.5%;margin-top:1px;" id="btnSalir" src="../vista/img/fileclose.png" onclick="ocultarDiv(\'divFormulario\');" /> </div>';
echo "<div  class='tablaFormInsertBody' align='center'>
     ...
     <tr><td align='center'><table border='0' cellspacing='0px' cellpadding='0px'>
        ...
        <tr><td><strong>Nombre</strong>       :</td><td> <input type='text' id='ru_nombre' placeholder='Terminal Museo' /> </td></tr>    
        <tr><td><strong>Descripción</strong>  :</td><td> <textarea style='width:200px;height:100px;' rows='4' cols='26' id='ru_descripcion' placeholder='Es una ruta ..'></textarea></td></tr>
         
        </table></td></tr>
     </table>
        
        <button style='margin-top:10px;margin-bottom:10px;' class='btn btn-success' id='botonn' onclick=\"validarCamposRuta();\">Guardar</button>
        <button style='margin-top:10px;margin-bottom:10px;' class='btn btn-success' onclick=\"ocultarDiv('divFormulario');\">Cerrar</button>
        <input type='text' id='opcion_rut' value='0' style='display:none'/>
