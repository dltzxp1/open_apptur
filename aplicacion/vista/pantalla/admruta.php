...
<html>
    <head>
        ...
        <script> 
            window.onload=consRuta(0,0,0,0,0);
        </script>
    </head> 
    <body>
        <div class="solobordeIng"  align="center">
            Adminsitración de Rutas
        </div> 
        <div id="cabBotones"> 
            <ul class="nav nav-tabs" style="height: auto;border-bottom: transparent solid 1px;margin-top: 5%;">
                <li><a title="Agregar Sitio" href="javascript:addRuta();verMapa();" ><img src="../vista/img/addRoute.png" /></a></li>
                <li><a title="Eliminar Sitio" href="javascript:delRutaDesdeMenu('chkHijoRol');"><img src="../vista/img/trash.png" /></a></li>
            </ul> 
            <ul class="nav nav-tabs nav-stacked" style="position: absolute;margin-left: 40%;margin-top: -20%;">
                <li>
                    <div class="btn-group" style="border-bottom: transparent solid 7px;">
                        ...
                        <ul class="dropdown-menu"  style="left: 0%;">
                            ...
                            for ($r = 0; $r < count($arrProvincia); $r++) {
                                echo "<li> <a href=\"javascript:selectProvinciaCanton_tri('" . $arrProvincia[$r]->pr_id . "','" . $arrProvincia[$r]->pr_nombre . "','consRuta');asignarProvincia('" . $arrProvincia[$r]->pr_nombre . "');\">" . $arrProvincia[$r]->pr_nombre . "</a></li>";
                            }
                            ?>
                        </ul>
                    </div>
