...
<html>
    <head>
        ...
        <script> 
            window.onload=consGastronomia(0,0,0,0,0);
        </script>
    </head>
    <body>
        <div class="solobordeIng" align="center">
            Adminsitración de Gastronomia
        </div>

        <div id="cabBotones">
            <ul class="nav nav-tabs" style="height: auto;border-bottom: transparent solid 1px;margin-top: 5%;">
                <li><a title="Agregar Gastronomia" href="../vista/pantalla/img/admgastronomia.php" target='_blank'><img src="../vista/img/addPlate.png" /></a></li>
                <li><a title="Eliminar Gastronomia" href="javascript:delGastronomiaDesdeMenu('chkHijoRol');"><img src="../vista/img/trash.png" /></a></li>
            </ul>
                    ...
                    <div class="btn-group" style="border-bottom: transparent solid 7px;">
                        ...
                        <ul class="dropdown-menu"  style="left: 0%;">
                            ...
                            for ($r = 0; $r < count($arrProvincia); $r++) {
                                echo "<li> <a href=\"javascript:selectProvinciaCanton_tri('" . $arrProvincia[$r]->pr_id . "','" . $arrProvincia[$r]->pr_nombre . "','consGastronomia');asignarProvincia('" . $arrProvincia[$r]->pr_nombre . "');\">" . $arrProvincia[$r]->pr_nombre . "</a></li>";
                            }
                            ?>
                        </ul>
                    </div>
