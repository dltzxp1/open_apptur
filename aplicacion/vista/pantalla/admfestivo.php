...
<html>
    <head>
        ...
        <script> 
            window.onload=consFestivo(0,0,0,0,0);
        </script>
    </head> 
    <body>
        <div class="solobordeIng" align="center">
            Adminsitración de Festivos
        </div>
        <div id="cabBotones"> 
            <ul class="nav nav-tabs" style="height: auto;border-bottom: transparent solid 1px;margin-top: 5%;">
                <li><a title="Agregar Festivo" href="javascript:addFestivo();" ><img src="../vista/img/addDate.png" /></a></li>
                <li><a title="Edita Festivo" href="javascript:editFestivoDesdeMenu('chkHijoRol');"><img src="../vista/img/edit.png" /></a></li>
                <li><a title="Eliminar Festivo" href="javascript:delFestivoDesdeMenu('chkHijoRol');"><img src="../imgvista/trash.png" /></a></li>
            </ul>
                    ...
                    <div class="btn-group" style="border-bottom: transparent solid 7px;">
                        ...
                        <ul class="dropdown-menu"  style="left: 0%;">
                            ...
                            for ($r = 0; $r < count($arrProvincia); $r++) {
                                echo "<li> <a href=\"javascript:selectProvinciaCanton_tri('" . $arrProvincia[$r]->pr_id . "','" . $arrProvincia[$r]->pr_nombre . "','consFestivo');asignarProvincia('" . $arrProvincia[$r]->pr_nombre . "');\">" . $arrProvincia[$r]->pr_nombre . "</a></li>";
                            }
                            ?>
                        </ul>
                    </div>
