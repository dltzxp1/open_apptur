...
$objSitio = new sitio($pr_id, $ca_id, $si_id, $em_id, $us_id);
...
<html>
    ...
    <script> 
        window.onload=consHistoria(0,0,0,0,0);
    </script>
    <body>
        <div class="solobordeIng" align="center">
            Adminsitración de Historia
        </div>

        <div id="cabBotones"> 
            <ul class="nav nav-tabs" style="height: auto;border-bottom: transparent solid 1px;margin-top: 5%;">
                <li><a title="Agregar Sitio" href="javascript:addHistoria();" ><img src="../vista/img/addHistory.png" /></a></li>
                <li><a title="Edita Sitio" href="javascript:editHistoriaDesdeMenu('chkHijoRol');"><img src="../vista/img/edit.png" /></a></li>
                <li><a title="Eliminar Sitio" href="javascript:delHistoriaDesdeMenu('chkHijoRol');"><img src="../vista/img/trash.png" /></a></li>
            </ul>
            ...
            <ul class="nav nav-tabs nav-stacked" style="position: relative;margin-left: 50%;margin-top: -18%;">
                <li> 
                    <div class="btn-group" style="border-bottom: transparent solid 7px;">
                        ...
                        <ul class="dropdown-menu"  style="left: 0%; overflow-x:hidden;overflow-y: auto;">
                            <?php
                            for ($r = 0; $r < count($arrProvincia); $r++) {
                                echo "<li> <a href=\"javascript:selectProvinciaCanton_tri('" . $arrProvincia[$r]->pr_id . "','" . $arrProvincia[$r]->pr_nombre . "','consHistoria');asignarProvincia('" . $arrProvincia[$r]->pr_nombre . "');\">" . $arrProvincia[$r]->pr_nombre . "</a></li>";
                            }
                            ?>
                        </ul>
                    </div>
                ...
                <li>
                    <div class="btn-group" style="border-bottom: transparent solid 7px;">
                        ...
                        <ul class="dropdown-menu" id="dropdown-menu_doble" style="left: 0%; overflow-x:hidden;overflow-y: auto;">
                            <li>
