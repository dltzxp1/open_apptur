...
<html>
    <head>
        ...
        <script> 
            window.onload=consFoto(0,0,0,0,0);
        </script>
    </head> 
    <body>

        <div class="solobordeIng" align="center">
            Adminsitración de Imagenes
        </div>

        <div id="cabBotones"> 

            <ul class="nav nav-tabs" style="height: auto;border-bottom: transparent solid 1px;margin-top: 5%;margin-left: 5%;">
                <!--<li><a title="Agregar Foto" href="../vista/pantalla/img/admfoto.php" target='_blank' onclick=""><img src="../vista/img/addPhoto.png" /></a></li>-->
                <li><a title="Agregar Festivo" href="javascript:addFoto();" ><img src="../vista/img/addDate.png" /></a></li>
                <li><a title="Eliminar Fotos" href="javascript:delFotoDesdeMenu('chkHijoRol');"><img src="../vista/img/trash.png" /></a></li>
            </ul> 
                    ...
                    <div class="btn-group" style="border-bottom: transparent solid 7px;">
                        ...
                        <ul class="dropdown-menu"  style="left: 0%;">
                            ...
                            for ($r = 0; $r < count($arrProvincia); $r++) {
                                echo "<li> <a href=\"javascript:selectProvinciaCanton_tri('" . $arrProvincia[$r]->pr_id . "','" . $arrProvincia[$r]->pr_nombre . "','consFoto');asignarProvincia('" . $arrProvincia[$r]->pr_nombre . "');\">" . $arrProvincia[$r]->pr_nombre . "</a></li>";
                            }
                            ?>
                        </ul>
                    </div>
