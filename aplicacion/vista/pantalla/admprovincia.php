...
<html>
    ...
    <script>
        window.onload=consProvincia('0');
    </script>
    <body>

        <div class="solobordeIng" align="center">
            Adminsitración de Provincias
        </div>

        <div id="cabBotones">
            <ul class="nav nav-tabs" style="height: auto;">
                <li><a title="Agregar Provincia" href="javascript:addProvincia();" ><img src="../vista/img/agregar.png" /></a></li>
                <li><a title="Edita Provincia" href="javascript:editProvinciaDesdeMenu('chkHijoRol');"><img src="../vista/img/edit.png" /></a></li>
                <li><a title="Eliminar Provincia" href="javascript:delProvinciaDesdeMenu('chkHijoRol');"><img src="../vista/img/trash.png" /></a></li>
            </ul>
        </div>
        <div id="divTabla" ></div>
